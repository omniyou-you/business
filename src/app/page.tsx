...
export default function KioskWebPortal() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#09090b]">
      ...
      <header className="border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-md py-3.5 px-4 sm:px-6 sticky top-0 z-50">
      ...
      {/* MAIN WIZARD BODY */}
      <main className="flex-1 max-w-5xl w-full mx-auto px-3 py-6 sm:px-6 sm:py-8 space-y-6 sm:space-y-8">
        {/* Wizard Progress Bar */}
      ...
      <footer className="border-t border-zinc-800 py-4 sm:py-6 text-center text-[11px] sm:text-xs text-zinc-400 bg-zinc-950">
