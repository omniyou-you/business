...
import { 
  Settings, Save, Check, Database, HardDrive, ShieldCheck, Server, AlertCircle
} from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-400">Configure base paper rates, color surcharges, and check cloud infrastructure health.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) => setPricing({ ...pricing, a4Rate: parseFloat(e.target.value) })}
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) => setPricing({ ...pricing, a3Rate: parseFloat(e.target.value) })}
                className="w-full h-10 rounded-lg bg-zinc-950 border border-zinc-800 px-3 font-mono text-xs text-white focus:outline-none focus:border-blue-500"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) => setPricing({ ...pricing, letterRate: parseFloat(e.target.value) })}
                className="w-full h-10 rounded-lg bg-zinc-950 border border-zinc-800 px-3 font-mono text-xs text-white focus:outline-none focus:border-blue-500"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) => setPricing({ ...pricing, legalRate: parseFloat(e.target.value) })}
                className="w-full h-10 rounded-lg bg-zinc-950 border border-zinc-800 px-3 font-mono text-xs text-white focus:outline-none focus:border-blue-500"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) => setPricing({ ...pricing, colorSurcharge: parseFloat(e.target.value) })}
                className="w-full h-10 rounded-lg bg-zinc-950 border border-zinc-800 px-3 font-mono text-xs text-white focus:outline-none focus:border-blue-500"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) => setPricing({ ...pricing, duplexDiscountPercent: parseInt(e.target.value) })}
                className="w-full h-10 rounded-lg bg-zinc-950 border border-zinc-800 px-3 font-mono text-xs text-white focus:outline-none focus:border-blue-500"
              />
            </div>
          </div>
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5 space-y-4 backdrop-blur-sm">
          <div className="border-b border-zinc-800/60 pb-3">
            ...
            <p className="text-[11px] text-zinc-400">Live operational status of storage and database integrations.</p>
          </div>
            ...
            <div className="p-3.5 rounded-lg bg-zinc-950/80 border border-zinc-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 font-mono">Ref: wsgqgloccdomkmfvxgbf</p>
                </div>
              </div>
